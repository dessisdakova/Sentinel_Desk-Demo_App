# SENT-401-QA — Test: Alert detail API and events endpoint
...
| **Implements after** | [SENT-401](./SENT-401.md) |
...
Design and implement automated tests for **SENT-401** — Alert detail API and events endpoint.
...
- [ ] Implementation ticket **SENT-401** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-401-1 | api | Happy path for primary AC | Pass |
| QA-401-2 | integration | One negative or edge case | Correct error or UI message |
| QA-401-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

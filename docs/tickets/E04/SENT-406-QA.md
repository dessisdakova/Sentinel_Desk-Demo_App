# SENT-406-QA â€” Test: Escalation UI on Summary tab
...
| **Implements after** | [SENT-406](./SENT-406.md) |
...
Design and implement automated tests for **SENT-406** â€” Escalation UI on Summary tab.
...
- [ ] Implementation ticket **SENT-406** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-406-1 | e2e | Happy path for primary AC | Pass |
| QA-406-2 | e2e | One negative or edge case | Correct error or UI message |
| QA-406-3 | e2e | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

# SENT-405-QA â€” Test: intel-embed static server and iframe tab
...
| **Implements after** | [SENT-405](./SENT-405.md) |
...
Design and implement automated tests for **SENT-405** â€” intel-embed static server and iframe tab.
...
- [ ] Implementation ticket **SENT-405** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-405-1 | integration | Happy path for primary AC | Pass |
| QA-405-2 | integration | One negative or edge case | Correct error or UI message |
| QA-405-3 | integration | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

# SENT-403-QA â€” Test: Alert detail React tabs
...
| **Implements after** | [SENT-403](./SENT-403.md) |
...
Design and implement automated tests for **SENT-403** â€” Alert detail React tabs.
...
- [ ] Implementation ticket **SENT-403** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-403-1 | e2e | Happy path for primary AC | Pass |
| QA-403-2 | e2e | One negative or edge case | Correct error or UI message |
| QA-403-3 | e2e | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

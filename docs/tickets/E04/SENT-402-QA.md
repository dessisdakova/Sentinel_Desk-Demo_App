# SENT-402-QA — Test: Escalation state machine and approval API
...
| **Implements after** | [SENT-402](./SENT-402.md) |
...
Design and implement automated tests for **SENT-402** — Escalation state machine and approval API.
...
- [ ] Implementation ticket **SENT-402** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-402-1 | api | Happy path for primary AC | Pass |
| QA-402-2 | integration | One negative or edge case | Correct error or UI message |
| QA-402-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

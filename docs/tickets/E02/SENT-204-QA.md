# SENT-204-QA — Test: Alert GET by id and basic list API
...
| **Implements after** | [SENT-204](./SENT-204.md) |
...
Design and implement automated tests for **SENT-204** — Alert GET by id and basic list API.
...
- [ ] Implementation ticket **SENT-204** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-204-1 | api | Happy path for primary AC | Pass |
| QA-204-2 | integration | One negative or edge case | Correct error or UI message |
| QA-204-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

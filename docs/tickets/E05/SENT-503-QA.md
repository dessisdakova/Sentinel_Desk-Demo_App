# SENT-503-QA â€” Test: Case list and detail UI
...
| **Implements after** | [SENT-503](./SENT-503.md) |
...
Design and implement automated tests for **SENT-503** â€” Case list and detail UI.
...
- [ ] Implementation ticket **SENT-503** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-503-1 | e2e | Happy path for primary AC | Pass |
| QA-503-2 | e2e | One negative or edge case | Correct error or UI message |
| QA-503-3 | e2e | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

# SENT-502-QA — Test: Case CRUD and link alerts API
...
| **Implements after** | [SENT-502](./SENT-502.md) |
...
Design and implement automated tests for **SENT-502** — Case CRUD and link alerts API.
...
- [ ] Implementation ticket **SENT-502** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-502-1 | api | Happy path for primary AC | Pass |
| QA-502-2 | integration | One negative or edge case | Correct error or UI message |
| QA-502-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

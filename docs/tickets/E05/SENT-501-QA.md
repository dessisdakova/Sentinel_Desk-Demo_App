# SENT-501-QA — Test: Case models and migration
...
| **Implements after** | [SENT-501](./SENT-501.md) |
...
Design and implement automated tests for **SENT-501** — Case models and migration.
...
- [ ] Implementation ticket **SENT-501** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-501-1 | api | Happy path for primary AC | Pass |
| QA-501-2 | integration | One negative or edge case | Correct error or UI message |
| QA-501-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

# SENT-601-QA — Test: Playbook and PlaybookRun models
...
| **Implements after** | [SENT-601](./SENT-601.md) |
...
Design and implement automated tests for **SENT-601** — Playbook and PlaybookRun models.
...
- [ ] Implementation ticket **SENT-601** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-601-1 | api | Happy path for primary AC | Pass |
| QA-601-2 | integration | One negative or edge case | Correct error or UI message |
| QA-601-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

# SENT-602-QA — Test: run_playbook Celery task
...
| **Implements after** | [SENT-602](./SENT-602.md) |
...
Design and implement automated tests for **SENT-602** — run_playbook Celery task.
...
- [ ] Implementation ticket **SENT-602** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-602-1 | api | Happy path for primary AC | Pass |
| QA-602-2 | integration | One negative or edge case | Correct error or UI message |
| QA-602-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

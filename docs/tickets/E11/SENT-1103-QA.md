# SENT-1103-QA — Test: aria-label pass on login, dashboard, alert queue
...
Design and implement automated tests for **SENT-1103** — aria-label pass on login, dashboard, alert queue.

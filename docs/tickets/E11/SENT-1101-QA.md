# SENT-1101-QA — Test: Bulk seed endpoint
...
| **Implements after** | [SENT-1101](./SENT-1101.md) |
...
Design and implement automated tests for **SENT-1101** — Bulk seed endpoint.
...
|----|-------|----------|----------|
| QA-1101-1 | api | Happy path for primary AC | Pass |
| QA-1101-2 | integration | One negative or edge case | Correct error or UI message |
| QA-1101-3 | api | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

# SENT-306-QA â€” Test: Queue auto-refresh polling
...
| **Implements after** | [SENT-306](./SENT-306.md) |
...
Design and implement automated tests for **SENT-306** â€” Queue auto-refresh polling.
...
- [ ] Implementation ticket **SENT-306** is complete and merged/runnable
...
|----|-------|----------|----------|
| QA-306-1 | e2e | Happy path for primary AC | Pass |
| QA-306-2 | e2e | One negative or edge case | Correct error or UI message |
| QA-306-3 | e2e | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |

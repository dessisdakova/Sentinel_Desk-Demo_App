# SENT-303-QA â€” Test: Alert queue React page and table
...
| **Implements after** | [SENT-303](./SENT-303.md) |
...
Design and implement automated tests for **SENT-303** â€” Alert queue React page and table.
...
|----|-------|----------|----------|
| QA-303-1 | e2e | Happy path for primary AC | Pass |
| QA-303-2 | e2e | One negative or edge case | Correct error or UI message |
| QA-303-3 | e2e | Data matches seed or TEST_DATA.md stable IDs where applicable | Consistent |
